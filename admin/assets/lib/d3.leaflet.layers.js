    ...
    updateData: function() {
      ...
      if(typeof layer_options.mouseover !='undefined'){
        ...
        .on("mouseout", function(self) {
          if(typeof layer_options.mouseover.style != 'undefined'){
            for(key in layer_options.mouseover.style){
              if(typeof layer_options.style[key] != 'undefined'){
      ...
      if (typeof this.options.stroke !== 'undefined') {
        ...
        feature.attr("stroke", function(d) {
          var color = '#3498db';
          if(typeof d.properties[choice] !== 'undefined' && d.properties[choice] != null){
            color = '#'+d.propertis[choice];
          }else{
            color = choice;
          }
          return color;
